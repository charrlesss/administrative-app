...
<script>
    $("#message-form").submit(function(e){
        ...
        $.ajax({
            type: "POST",
            url: '/freight/create-message',
            data: ({message:formData.get("visitor-message" ).trim()}),
            dataType: 'json',
            success: function(res){
                inquirersParticipants((resp)=>{
                    console.log(resp)
                })
            },
...
<script>
    document.getElementById('visitor-message').addEventListener('keypress',(event)=>{
