...
<div class="flex gap-2 p-2 ">
    ...
    <?php
    if($_SERVER['REQUEST_URI'] !== "/freight/administrative/admin/visitor-management-dashboard"){
    ?>
    <a href="/freight/administrative/admin/visitor-management-dashboard">
...
<div class="w-auto h-auto  p-1  relative">
    ...
    <img
        ...
        src="
        <?php 
        $profile = $_SESSION['visitor-management-account']['profile'];
