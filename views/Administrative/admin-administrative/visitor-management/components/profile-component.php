        ...
        <div class="z-[50] md:w-[200px] md:h-[200px] w-[170px] h-[170px] relative ">
           ...
           <div class=" md:flex hidden w-auto h-auto items-center ml-5 ">
                <div class="flex flex-col">
                    <h1 class="text-3xl w-full overflow-hidden whitespace-nowrap	"><?php echo limitString($_SESSION['visitor-management-account']['fullname']); ?> </h1>
                    <p class="uppercase text-xs font-semibold text-gray-300 tracking-[2px]"><?php echo $_SESSION['visitor-management-account']['country']; ?></p>
                </div> 
            </div>
    </div>
...
<script>
    const profile =  "<?php echo $_SESSION['visitor-management-account']['profile'] ?>"
    const fullname ="<?php echo $_SESSION['visitor-management-account']['fullname'] ?>"
    const email ="<?php echo $_SESSION['visitor-management-account']['email'] ?>"
    const mb_number ="<?php echo $_SESSION['visitor-management-account']['contact_number'] ?>"
    const country = "<?php echo $_SESSION['visitor-management-account']['country'] ?>"
    const birthdate = "<?php echo $_SESSION['visitor-management-account']['birthdate'] ?>"
    const address = "<?php echo $_SESSION['visitor-management-account']['address'] ?>"
    const gender = "<?php echo $_SESSION['visitor-management-account']['gender'] ?>"
</script>
...
<script>
   function defaultValue (input){
    const myFile = new File(['Hello World!'], '"<?php echo $GLOBALS['url']."/assets/profile/".$_SESSION['visitor-management-account']['profile']; ?>', {
            type: 'text/plain',
...
defaultValue(input)
let uploadfile
img.src ="<?php echo $GLOBALS['url']."/assets/profile/".$_SESSION['visitor-management-account']['profile']; ?>"
