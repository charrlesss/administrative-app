...
array(
  ...
  '),
  "link"=>'/freight/administrative/admin/visitor-management-dashboard/profile'
    ), 
    array(
      "name"  => "Visitors",
      "icon" => 
    ...
    '),
    "link"=>'/freight/administrative/admin/visitor-management-dashboard/visitors'
      ),
array(
    "name"  => "Inquirers",
    "icon" => 
  ...
  "link"=>'/freight/administrative/admin/visitor-management-dashboard/inquirers'
), 
array(
  ...
  "link"=>'/freight/administrative/admin/visitor-management-dashboard/appointment-request'
    ...
    '),
    "link"=>'/freight/administrative/admin/visitor-management-dashboard/qrcode-scanner'
  )
];
?>
    ...
    <div class="w-full h-auto flex  flex-col justify-center mb-10">
        <div class="w-full h-auto flex justify-center">
            <div class="border-2 bg-transparent z-[100] md:w-[200px] md:h-[200px] w-[170px] h-[170px] bg-gray-50 flex overflow-hidden relative  justify-center items-center rounded-full " id="drop-box" >
                    ...
                    src="
                    <?php 
                $profile = $_SESSION['visitor-management-account']['profile'] ?  $_SESSION['visitor-management-account']['profile'] : "profile_default.jpg";
        ...
        <p class="text-center mt-5"><?php echo $_SESSION['visitor-management-account']['fullname'] ?></p>
    </div>
