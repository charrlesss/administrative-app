...
<main id="main"  class="w-screen h-screen relative">
    <div class="flex relative h-full w-full ">
        ...
        <!-- header -->
         ...
         <!-- content -->
            <div id="root" class=" sm:h-[calc(100%-50px)] h-auto w-full  mt-16">
                <form id="update-profile" class=" w-full h-full  px-10  " >
                    ...
                    <div class="w-full relative h-auto flex md:justify-start justify-center ">
                        <div class="z-[50] md:w-[200px] md:h-[200px] w-[170px] h-[170px] relative ">
                            <div class=" relative bg-transparent z-[50] md:w-[200px] md:h-[200px] w-[170px] h-[170px]  flex overflow-hidden relative  justify-center items-center rounded-full " id="drop-box" >
                                <img
                                    id="img"
                            ...
                            <div class="">
                                        ...
                                        <div class="form-inner">
                                                ...
                                                <div  class="flex gap-x-4 w-full h-auto md:flex-row flex-col mt-2">
                                                    <div  class="form-group  w-full"  id="bd-container" >
                                                        ...
                                                        <input class="form-control"  type="text" placeholder="DD-MM-YYYY" id="datepicker" autocomplete="off" name="birthdate"  required>
                                                    </div>
                                            ...
                                            <div  class="form-group flex my-3 gap-x-3 items-center ">
                                                        <div class="flex items-end ">
                                                            <input id="male" type="radio" value="male" name="gender" required class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                                            <label for="male" class="ml-2 text-[11px] uppercase text-indigo-900 font-semibold" >Male</label>
                                                        </div>
                                                        <div class="flex items-end ">
                                                            <input checked id="female" type="radio" value="female" name="gender" required class="w-4 h-4 text-blue-600 border-gray-300 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600">
                                ...
                                <div class=" flex justify-between items-center pt-5  space-x-2 rounded-b ">
                                    <div class="flex gap-x-3">
                                        <button type="submit" type="button" class="text-white bg-green-700 hover:bg-green-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg md:text-sm text-xs px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Save Changes</button>
                                        <button id='reset' type="button" class="text-white bg-gray-700 hover:bg-gray-800 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg md:text-sm text-xs px-5 py-2.5 text-center dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">Reset</button>
                                    </div>
            ...
            <form id='modal'  class="hidden absolute top-[100px] left-[50%] -translate-x-[50%] md:w-[650px] w-[calc(100%-20px)] h-auto z-[100]">
...
<script>
     $("#modal").submit(function(e){
        ...
        confirmButtonText: 'Yes, Change it!'
            ...
            if (result.isConfirmed) {
                ...
                const id = "<?php echo $visitor_id ?>"

                $.ajax({
                    type: 'post',
                    url: '/freight/update-visitor-password',
                    dataType:'json',
                    data: ({visitor_id:id,password:formData.get('password'),confirmPassword:formData.get('confirmPassword')}),
    ...
    $("#btn-change-password").click(function(){
        $("#modal").toggle("hidden")
        $("#root").toggle("hidden")
        $("#modal")[0].classList.add('md:left-60%')
        $("#main")[0].className ="w-full h-screen bg-gray-200"
    })
    $("#close-modal").click(function(){
        $("#modal").toggle("hidden")
        $("#root").toggle("hidden")
        $("#main")[0].className ="w-full h-screen "
    })
   ...
   function init(
    ...
    const url = '<?php echo $GLOBALS['url']."/assets/profile/";?>' + profile
    ...
    const profile_fullname = document.querySelector('#profile_fullname')
    const profile_country = document.querySelector('#profile_country')

    handleProfile(input,url,discription,filename)
    handleInput(country)
    profile_fullname.textContent = fullname
    profile_country.textContent = country
    ...
    if(inputProfile ===  profile &&
       ...
       formData.get('gender') === gender){
        ...
        formData.append('visitor_id' ,"<?php echo $visitor_id ?>")
...
<script>
   function defaultValue (input,url){
   
    const myFile = new File(['Hello World!'],url, {
            type: 'text/plain',
...
<script> 
function handleProfile(input,url,discription,filename){
