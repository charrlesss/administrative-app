...
<script>
   ...
   function filterLogicCallback(data,input){
      ...
      data.contact_number.toLowerCase().search(input.toLowerCase()) >= 0 ||
   ...
   function comparisonLogicCallback(a,b){
    return (
      ...
      a.contact_number.localeCompare(b.contact_number) ||
    ...
    function displayData(res){
      ...
      res.forEach((data,idx) => {
            ...
            <tr onclick='closekAction()' class="bg-white border-b transition duration-100 ease-in-out hover:bg-gray-100 -z-[100]">
                ...
                <td class="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900">${data.contact_number}</td>
...
function onClickAction(idx,e){
    ...
    function sortByContact(arr,cb){
        cb(arr.sort(function (a, b) {
            return (
              b.contact_number.localeCompare(a.contact_number)
            );
        }))
    }
...
<script>
    ...
    init(
    {url:"/freight/visitor-management-get-all-accounts"},
      {headerArray},
      root,
