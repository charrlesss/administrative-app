...
array(
  ...
  '),
  "link"=>"/freight/administrative/visitor-dashboard/profile"
    ), 
array(
    "name"  => "Inquirers",
    "icon" => 
  ...
  "link"=>"/freight/administrative/visitor-dashboard/inquirers"
), 
array(
  ...
  '),
  "link"=>"/freight/administrative/visitor-dashboard/appointment-request"
),
array(
    "name"  => "Company Facility",
    "icon" => 
    html_entity_decode(
    '<svg class="h-8 w-8 text-indigo-500"  width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round">  <path stroke="none" d="M0 0h24v24H0z"/>  <path d="M3 21v-13l9-4l9 4v13" />  <path d="M13 13h4v8h-10v-6h6" />  <path d="M13 21v-9a1 1 0 0 0 -1 -1h-2a1 1 0 0 0 -1 1v3" /></svg>'
    ),
    "link"=>"/freight/administrative/visitor-dashboard/company-facility"
)
];
?>
...
<div id="sidebar" class=" z-[100] bg-indigo-50 shadow-2xl xl:w-[350px] w-[300px] transition-all h-full border xl:relative absolute transition-all ">
  <div id="sidebar-container" class="bg-indigo-50 transition-all">
    ...
    <div class="w-full h-auto flex  flex-col justify-center mb-10">
        ...
        <p class="text-center mt-5"><?php echo $_SESSION['visitor_account']['fullname'] ?></p>
    </div>
