...
<main class="w-screen h-screen ">
            ...
            <div class=" sm:h-[calc(100%-50px)] h-auto w-full  mt-16">
                <div class=" w-full h-auto flex xl:flex-row flex-col relative ">
                    ...
                    <div class=" w-full h-auto relative p-3 ">
                        <?php
                            include( $_SERVER['DOCUMENT_ROOT'].'/freight/views/Administrative/client-administrative/components/request-form-created.administrative.php');
                        ?>
                    </div>
                    ...
                    <div class=" xl:w-[70%] w-auto  xl:h-full h-auto relative ">
                        <h2 class=" uppercase font-semibold text-lg mb-5 text-indigo-500 text-center">Expected visitor a day in the company.</h2>
                            <div class=" block relative flex lg:flex-row flex-col lg:gap-x-4 lg:gap-y-0 gap-y-4">
                                    <?php
                                        include( $_SERVER['DOCUMENT_ROOT'].'/freight/views/Administrative/client-administrative/components/calendar.administrative.php');
                                    ?>
                                    <div class="relative lg:w-[55%] w-full h-[500px] overflow-y-scroll border-x-[1px] border-b-[1px]   ">
                                        <div class="relative w-full h-auto  ">
                                            <?php
                                        include( $_SERVER['DOCUMENT_ROOT'].'/freight/views/Administrative/client-administrative/components/visitor-list-table.administrative.php');
                                        ?>
                                    </div>
                               </div>
                            </div>
                        ...
                        <h1 class="uppercase text-lg font-semibold text-indigo-500 py-5">total visitor</h1>
                            <div>
                                <?php
                                  include( $_SERVER['DOCUMENT_ROOT'].'/freight/views/Administrative/client-administrative/components/visitor-chart.administrative.php');
                                ?>
                            </div>
                        </div>
                </div>
    ...
    <?php
    // echo $_SESSION['visitor_account']['profile'];
        if(
        ...
        empty($_SESSION['visitor_account']['country'])){
                include( $_SERVER['DOCUMENT_ROOT'].'/freight/views/Administrative/client-administrative/components/modal-complete-details.administrative.php');
            }
        ?>
</main>
